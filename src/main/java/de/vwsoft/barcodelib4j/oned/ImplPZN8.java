 ...
 * its data. As a result, this class extends the abstract class {@link LineageTwoWidth}, as Code 39
 * is a type of two-width barcode. See the linked class description for more information.
 */
