...
public final class DataMatrixWriter implements Writer {
  ...
  public BitMatrix encode(String contents, BarcodeFormat format, int width, int height, Map<EncodeHintType,?> hints) {
    ...
    boolean hasGS1FormatHint = false; // #vw
    if (hints != null) {
      ...
      hasGS1FormatHint = gs1 != null ? Boolean.parseBoolean(gs1.toString()) : false; // #vw
    }
...
//          Boolean.parseBoolean(hints.get(EncodeHintType.GS1_FORMAT).toString());
      ...
      // #vw Add support for GS1 also in non-compact mode
