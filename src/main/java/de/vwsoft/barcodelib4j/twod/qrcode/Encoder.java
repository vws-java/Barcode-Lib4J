...
import de.vwsoft.barcodelib4j.twod.zxing.WriterException;
import de.vwsoft.barcodelib4j.twod.zxing.common.BitArray;
import de.vwsoft.barcodelib4j.twod.zxing.common.CharacterSetECI;
import de.vwsoft.barcodelib4j.twod.zxing.common.GenericGF;
import de.vwsoft.barcodelib4j.twod.zxing.common.ReedSolomonEncoder;
...
public final class Encoder {
  ...
  // #vw Taken from the StringUtils class to be able to delete it, as it is not used elsewhere
  ...
  private static Mode chooseMode(String content, Charset encoding) {
    if (SHIFT_JIS_CHARSET != null &&
        SHIFT_JIS_CHARSET.equals(encoding) &&
