...
package twodcode.datamatrix;

import twodcode.BarcodeFormat;
import twodcode.EncodeHintType;
import twodcode.Writer;
import twodcode.common.BitMatrix;
import twodcode.Dimension;
import twodcode.qrcode.ByteMatrix;
...
public final class DataMatrixWriter implements Writer {
  ...
  public BitMatrix encode(String contents, BarcodeFormat format, int width, int height, Map<EncodeHintType,?> hints) {
    ...
    if (hints != null) {
      ...
      Object gs1 = hints.get(EncodeHintType.GS1_FORMAT);                      // #vw
      gs1Format = gs1 != null ? Boolean.parseBoolean(gs1.toString()) : false; // #vw
    }
    ...
    String encoded = HighLevelEncoder.encodeHighLevel(contents, shape, minSize, maxSize, gs1Format);
