...
//  }
  ...
  public static String encodeHighLevel(String msg,
                                       ...
                                       Dimension minSize,
                                       Dimension maxSize,
                                       boolean isGS1) { // #vw additional parameter
    ...
    // #vw In case of GS1 the method parameter 'msg' should be passed as a valid GS1 number, using
    // {GS} (ASCII 29) as separator char, as FNC1 (ASCII 232) will not work together with the above
    // code. Also it should NOT hold FNC1 at it's first position.
    if (isGS1) {
